...
export default function EmptyState() {
  return (
    <div className="glass-premium rounded-2xl p-8 md:p-12 text-center max-w-lg mx-auto relative overflow-hidden border border-gold-500/10 select-none">
      {/* Background illustration */}
      <div
        className="w-40 h-40 mx-auto rounded-full bg-cover bg-center border-2 border-gold-500/20 shadow-[0_0_30px_rgba(188,124,10,0.15)] mb-6 opacity-80"
